...
public class SolutionAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        //(View를 만들고 싶은 레이아웃 파일의 id, 생성될 View의 parent, true 로 설정해 줄 경우 root의 자식 View로 자동으로 추가, 이때 root는 null 일 수 없음)
        return new RecyclerView.ViewHolder(layoutInflater) {};//attachToRoot에 따라서 리턴값이 달라짐, true일 경우 root가, false일 경우 XML내 최상위 뷰가 리턴
    }
